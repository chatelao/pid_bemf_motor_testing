...
# Goal
Create tool sketches for the XIAO 2040, XIAO RA4M1, Nucleo STM32F446RE and STM32G431 using BDR6133 to test Märklin Motor behaviour after refit with permanent magnets to analyze and calibrate a PID driver using BEMF.
